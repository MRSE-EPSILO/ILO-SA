...
<div class="contenedor-imagen">
  <img src="hoja1.png" alt="Imagen 1">
  <img src="hoja2.png" alt="Imagen 2">
  <img src="hoja3.png" alt="Imagen 3">
</div>
...
.image-previous {
  opacity: 0.5;
  left: -100%; /* Mover la imagen a la izquierda para que se muestre al lado */
}
</style>
...
function changeImage() {
  images[currentImage].classList.add('image-previous'); // Agregar clase a la imagen anterior
  images[currentImage].style.opacity = 0;

  currentImage = (currentImage + 1) % images.length;

  images[currentImage].style.opacity = 1;
  images[currentImage].classList.remove('image-previous'); // Eliminar clase de la imagen anterior
}
...
Aquí te mostramos una breve presentación acerca de lo que implican los MRSE Hídricos.<br>


> Si deseas visualizar la presentación en modo pantalla completa presiona **F** después de hacer clic sobre la presentación. También posee controles adicionales, para conocerlos presiona **H** después de haber seleccionado la presentación.

```{r}
embed_xaringan("m2/pres.html",ratio="4:3")
```

<span style="color:darkblue;font-weight:bold;">Información de contacto</span>
...
<iframe width="100%" height="692" frameborder="10" title="Felt Map" src="https://felt.com/map/MRSE-H-q4wyI3qcRr6gFqjR8mxgPC?loc=-17.04664,-70.49325,13.48z"></iframe>
